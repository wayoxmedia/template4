  ...
  <div class="container py-5">
    <div class="row justify-content-start">
      <div class="col-lg-8 text-center text-lg-start">
        <h1 class="font-secondary text-primary mb-4"><?= TXT_DESCRIPTION;?></h1>
        <h1 class="display-1 text-uppercase text-white mb-4"><?= SITE_NAME;?></h1>
        <h1 class="text-uppercase text-white"><?= TXT_DESCRIPTION2;?></h1>
